...
use Elfcms\Basic\Models\RoleUser;
use Elfcms\Basic\Models\User;
use Elfcms\Basic\Models\UserData;
...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        $defaultRoleCode = Config::get('elf.user_default_role');

        if (!$defaultRoleCode) {
            $defaultRoleCode = 'users';
        }
        return view('basic::admin.users.create',[
            'page' => [
                'title' => 'Create user'
            ],
            'roles' => $roles,
    ...
    {
        return view('basic::admin.users.show',[
            'page' => [
                'title' => 'Show user'
            ]
        ]);
    ...
    public function edit(User $user)
    {
        ...
        return view('basic::admin.users.edit',[
            'page' => [
                'title' => 'Edit user'
            ],
            'user' => $user,
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (!empty($request->file('data')['thumbnail'])) {
            $thumb = $request->file('data')['thumbnail']->store('public/users/avatars/thumbnails');
            $thumb = str_ireplace('public/','/storage/',$thumb);
        }
        if (!empty($request->file('data')['photo'])) {
            $photo = $request->file('data')['photo']->store('public/users/avatars/photos');
