...
class FormFieldGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('basic::admin.form.groups.index',[
            'page' => [
    ...
    {
        $forms = Form::all();
        return view('basic::admin.form.groups.create',[
            'page' => [
                'title' => 'Create group',
                'current' => url()->current(),
            ],
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'name' => 'required',
            'code' => 'required|unique:App\Models\FormFieldGroup,code',
    ...
    public function show(FormFieldGroup $group)
    {
        ...
        return view('basic::admin.form.groups.show',[
            'page' => [
                'title' => 'Form field group #' . $group->id,
                'current' => url()->current(),
            ],
            'fields' => $fields,
            'group' => $group
    ...
    {
        $forms = Form::all();
        return view('basic::admin.form.groups.edit',[
            'page' => [
