...
class FormFieldController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('basic::admin.form.fields.index',[
            'page' => [
                'title' => 'Form fields',
                'current' => url()->current(),
            ],
    ...
    public function create(Request $request)
    {
        ...
        //}
        return view('basic::admin.form.fields.create',[
            'page' => [
                'title' => __('basic::elf.create_field'),
                'current' => url()->current(),
            ],
            'groups' => $groups,
            'forms' => $forms,
    ...
    public function edit(FormField $field)
    {
        ...
        return view('basic::admin.form.fields.edit',[
            'page' => [
                'title' => __('basic::elf.edit_field') . ' #' . $field->id,
                'current' => url()->current(),
            ],
            'field' => $field,
            'groups' => $groups,
