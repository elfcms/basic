                ...
                <tr data-id="{{ $item->id }}" class="level-{{ $item->level }}@empty ($item->active) inactive @endempty">
                    ...
                    <td class="button-column">
                        <form action="{{ route('admin.menu.items.create') }}" method="GET">
                            ...
                            <button type="submit" class="default-btn submit-button">{{ __('basic::elf.add_subitem') }}</button>
                        </form>
                        <a href="{{ route('admin.menu.items.edit',$item->id) }}" class="default-btn edit-button">{{ __('basic::elf.edit') }}</a>
