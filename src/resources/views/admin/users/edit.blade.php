...
<div class="user-form item-form">
    <h3>{{ __('basic::elf.edit_user') }}{{ $user->id }}</h3>
    <form action="{{ route('admin.users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="colored-rows-box">
            ...
            <div class="input-box colored">
                <label for="password">{{ __('basic::elf.password') }}</label>
                <div class="input-wrapper">
                    <input type="password" name="password" id="password" autocomplete="off" value="">
                </div>
            </div>
            <div class="input-box colored">
                <label for="password_confirmation">{{ __('basic::elf.confirm_password') }}</label>
                <div class="input-wrapper">
